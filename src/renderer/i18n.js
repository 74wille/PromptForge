...
const STRINGS = {
  sv: {
    ...
    'env.cwd': 'Startmapp',
    'env.cwdHint': 'Mappen nya sessioner öppnas i. Utan eget val används Dokument.',
    'env.cwdHomeWarning': 'Claude Code sparar aldrig ditt svar på ”Do you trust the files in this folder?” för hemmappen, så frågan kommer tillbaka vid varje ny session. Välj en projektmapp i stället.',
    'env.pickFolder': 'Välj mapp',
    'env.resetFolder': 'Standardmapp',
  ...
  en: {
    ...
    'env.cwdHint': 'The folder new sessions open in. Documents is used unless you pick one.',
    'env.cwdHomeWarning': 'Claude Code never saves your answer to “Do you trust the files in this folder?” for the home folder, so the question comes back with every new session. Pick a project folder instead.',
    'env.pickFolder': 'Pick folder',
    'env.resetFolder': 'Default folder',
